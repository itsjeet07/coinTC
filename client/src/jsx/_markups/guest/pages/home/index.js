      ...
      <section id="startCrypto">
        <div className="container">
          <div className="start_crypto_content d-flex justify-content-center">
            ...
            <Link to="/login" className="btn btn_getstarted wow fadeInLeft">
              {t("Get stared")}
            </Link>
          </div>
        </div>
              ...
              return (
                <tr key={key}>
                  ...
                  >
                    ...
                    <Link to={{ pathname: '/advert/create', data: "buy" }} className="btn_buy">Buy</Link>
                    <Link to={{ pathname: '/advert/create', data: "sell" }} className="btn_trade">
                      Sell
                    </Link>
                  </td>
                </tr>
